...
## Run Instructions:
1. Open notebook in Google Colab @ https://colab.research.google.com/drive/1tfSbsaHb54EdOE2QorwpGppnRFlLnFyr?usp=sharing
2. Run first cell for installing dependencies - !pip install transformers datasets accelerate bitsandbytes peft wandb
3. Upload your variant.json(provided in this repo) file to your notebook environment
4. Run each notebook cell squentially to reproduce results
5. Results are discussed in results file
